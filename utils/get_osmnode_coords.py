...
stations = csv.DictReader(open("kiev_stations.csv", 'rb'), delimiter=',')
input_fnames = stations.fieldnames
output_f = csv.DictWriter(open('kiev_stations_new.csv', 'wb'), input_fnames, delimiter=';')
output_f.writeheader()

msk_bnd = "37.1867,55.4465,38.275,55.9842"
spb_bnd = "29.6617,59.7592,30.817,60.1743"
kiev_bnd = "30.2420,50.2566,30.8561,50.5753"

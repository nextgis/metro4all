...
minLiftAmount = pd.DataFrame({'minLiftAmount' : sourceDf.groupby(by='station_id')['lift'].min()})
maxLiftAmount = pd.DataFrame({'maxLiftAmount' : sourceDf.groupby(by='station_id')['lift'].min()})

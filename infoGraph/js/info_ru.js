var tr = {
	...
	'stationHeader': {
		...
		'minRailsStairs': 'Минимальная протяжённость лестниц на маршрутах с учетом рельсов и пандусов, ступенек',
		'avRailsStairs': 'Средняя протяжённость лестниц на маршрутах с учетом рельсов и пандусов, ступенек',
		'maxRailsStairs': 'Максимальная протяжённость лестниц на маршрутах с учетом рельсов и пандусов, ступенек',
	...
	'nodeHeader': {
		...
		'stairwaysAmount': 'Количество групп эскалаторов',
		'doorsAndTapersAmount': 'Количество групп дверей',
		'minDoorAndTaperWidth': 'Минимальная ширина дверей, мм',
		'turnstilesAmount': 'Количество групп турникетов',
		...
		'minRailsWidth': 'Минимальная ширина рельсов, мм',
		'maxRailsWidth': 'Максимальная ширина рельсов, мм',
		'maxRailsSlope': 'Максимальный уклон рельсов, %'
	},
	'accessibilityHeader': {
	...
	'transferHeader': {
		...
		'minRailsStairs': 'Протяжённость лестниц с учетом рельсов и пандусов, ступенек',
		'minLiftStairs': 'Протяжённость лестниц с учетом лифтов, ступенек',
		'minStairways': 'Количество групп эскалаторов',
		'lift': 'Количество лифтов',
		'minRailsWidth': 'Минимальная ширина рельсов, мм',
		'maxRailsWidth': 'Максимальная ширина рельсов, мм',
		'maxSlope': 'Максимальный уклон рельсов, %',
